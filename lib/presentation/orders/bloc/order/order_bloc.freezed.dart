...
class _$CreateOrderImpl implements _CreateOrder {
  ...
  @override
  String toString() {
    return 'OrderEvent.createOrder(addressId: $addressId, paymentMethod: $paymentMethod, shippingService: $shippingService, shippingCost: $shippingCost, paymentName: $paymentName, products: $products)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return createOrder(addressId, paymentMethod, shippingService, shippingCost,
        paymentName, products);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return createOrder?.call(addressId, paymentMethod, shippingService,
        shippingCost, paymentName, products);
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    if (createOrder != null) {
      return createOrder(addressId, paymentMethod, shippingService,
          shippingCost, paymentName, products);
    }
    return orElse();
  }
...
abstract class _CreateOrder implements OrderEvent {
  const factory _CreateOrder(
      ...
      required final List<ProductQuantity> products}) = _$CreateOrderImpl;
