...
import 'package:flutter_onlineshop_app/core/extensions/int_ext.dart';
          ...
          BlocBuilder<CheckoutBloc, CheckoutState>(
            builder: (context, state) {
              return state.maybeWhen(
                ...
                loaded: (products, _, __, ___, ____, _____, _________) {
              ...
              BlocBuilder<CheckoutBloc, CheckoutState>(
                builder: (context, state) {
                  final totalShippingCost = state.maybeWhen(
                      orElse: () => 0,
                      loaded: (_, __, ___, ____, shippingCost, _____, _______) {
                        return shippingCost;
                      });
                  return Text(
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              subtitle: Text(
                                  'Estimasi tiba ${item.cost![0].etd} hari kerja'),
                            );
                          },
                          separatorBuilder: (context, index) =>
                              const Divider(color: AppColors.stroke),
