                      ...
                      children: [
                        Text(
                          banks
                              .where((element) =>
                                  element.code ==
                                  orderResponseModel.order!.paymentName!)
                              .first
                              .name,
                    ...
                    BlocBuilder<OrderBloc, OrderState>(
                      builder: (context, state) {
                        return state.maybeWhen(
                          ...
                          loaded: (orderResponseModel) {
                            return Text(
                              orderResponseModel.order!.paymentVa!,
                              style: const TextStyle(
                                fontSize: 16,
                      ...
                      return Button.outlined(
                        ...
                        onPressed: () {
                          Clipboard.setData(ClipboardData(
                                  text: orderResponseModel.order!.paymentVa!))
                              .then((_) {
              ...
              builder: (context, state) {
                return state.maybeWhen(orElse: () {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text(
                      orderResponseModel.order!.totalCost!.currencyFormatRp,
                      style: const TextStyle(
                        fontSize: 16.0,
                        fontWeight: FontWeight.w700,
                      ),
